...
from registrar.utils import render_to_pdf
...
#@login_required()
#def getdpf(self, request, *args, **kwargs):
#   template=get_template('registrar/certificate/certificate.html')
 #   context = {
  #      "student" : student.user.first_name
   # }
    #html = template.render(context)
    #pdf = render_to_pdf(certificate_page, context)
